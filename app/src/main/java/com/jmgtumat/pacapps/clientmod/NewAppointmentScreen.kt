...
@Composable
fun NewAppointmentScreen(navController: NavHostController, viewModel: AppViewModel) {
    val servicios by viewModel.servicioViewModel.servicios.observeAsState(emptyList())
    val citas by viewModel.citaViewModel.citas.observeAsState(emptyList())
    val empleados by viewModel.empleadoViewModel.empleados.observeAsState(emptyList())
        ...
        if (showConfirmationDialog) {
            selectedSlot?.let { slot ->
                ConfirmationDialog(
                    ...
                    onConfirm = {
                        viewModel.citaViewModel.insertCita(
                            Cita(
